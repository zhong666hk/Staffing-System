package com.wbu.staff.generator.util;
...
public class DbUtil {
     ...
     * @throws Exception
     */
    public static List<com.wbu.staff.generator.generator.util.Field> getColumnByTableName(String tableName) throws Exception {
        List<com.wbu.staff.generator.generator.util.Field> fieldList = new ArrayList<>();
        Connection conn = getConnection();
        Statement stmt = conn.createStatement();
        ...
        if (rs != null) {
            while(rs.next()) {
                ...
                com.wbu.staff.generator.generator.util.Field field = new com.wbu.staff.generator.generator.util.Field();
