package com.wbu.staff.generator;

import com.wbu.staff.generator.util.DbUtil;
...
public class MAIN {
    static String ftlPath = "generator/src/main/java/com/wbu/staff/generator/ftl";
    static String genPath = "[model]/src/main/java/com/wbu/staff/[model]/";
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (tableName.contains("_")){
            String doMain = domainObjectName.substring(0, 1).toLowerCase() + domainObjectName.substring(1);
            map.put("doMain",doMain);
        }else {
        ...
        for (int i = 0; i < FileNameArray.length; i++) {
            String ftlName=domainObjectName+FileNameArray[i].substring(0,1).toUpperCase()+FileNameArray[i].substring(1)+".java";
            // 模板名字
        ...
        // 查询字段对应名字
        List<com.wbu.staff.generator.generator.util.Field> fieldList = DbUtil.getColumnByTableName(tableName);
        // 获取import要引入的对象包
     ...
     * @return
     */
    private static Set<String>  getJavaTypes(List<com.wbu.staff.generator.generator.util.Field> fieldList) {
        Set<String> set = new HashSet<>();
        for (int i = 0; i < fieldList.size(); i++) {
            com.wbu.staff.generator.generator.util.Field field = fieldList.get(i);
